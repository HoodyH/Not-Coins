"""
Django settings for NotCoins project.
...
SECRET_KEY = 'grz+1__ttq0_l&5!kb#tped-tfy^fz5wrw%#u*pyjv_-xexe!t'
...
WSGI_APPLICATION = 'NotCoins.wsgi.application'
